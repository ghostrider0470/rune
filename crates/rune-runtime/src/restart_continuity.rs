...
pub const RESTART_CONTINUITY_SUMMARY: &str = "restart continuity is intentionally partial: durable approval requests, operator-triggered resume, resumed-session notification, and session/transcript restoration are supported across restart; in-flight turns, live process handles, and typing/progress UI do not resume in place";
