...
- `crates/rune-gateway/src/routes.rs`
  ...
  - session status views surface orchestration metadata including mode, delegation roles/depth, parent linkage, preemption-aware resume hints, and unresolved parity notes
